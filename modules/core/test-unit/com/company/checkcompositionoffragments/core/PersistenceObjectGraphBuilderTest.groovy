...
import com.company.checkcompositionoffragments.core.subpackage.E
...
class PersistenceObjectGraphBuilderTest extends Specification {
    ...
    void setup() {
        ...
        delegate.classNameResolver = "com.company.checkcompositionoffragments.core"
    }
 ...
 Graph is interpreted, not compiled and run after all.'''() {
    ...
    def "ClassNameResover supports list of packages for resolving class objects"() {
        given:
        delegate.classNameResolver = ["com.company.checkcompositionoffragments.core", "com.company.checkcompositionoffragments.core.subpackage"]
